...
Usage: dy query [OPTIONS] <PVAL>

Arguments:
  <PVAL>  Target Partition Key

Options:
  -s, --sort-key <SORT_KEY_EXPRESSION>  Additional Sort Key condition which will be converted to KeyConditionExpression. Valid syntax: ['= 12', '> 12', '>= 12', '< 12', '<= 12', 'between 10 and 99', 'begins_with myVal"]
  ...
  -l, --limit <LIMIT>                   Limit the number of items to return. By default, the number of items is determined by DynamoDB
  ...
  -d, --descending                      Results of query are always sorted by the sort key value. By default, the sort order is ascending. Specify --descending to traverse descending order
