...
pub async fn create_table_api(
    ...
    TableDescription,
    aws_smithy_http::result::SdkError<aws_sdk_dynamodb::operation::create_table::CreateTableError>,
> {
    debug!(
...
async fn update_table_api(
    ...
    TableDescription,
    aws_smithy_http::result::SdkError<aws_sdk_dynamodb::operation::update_table::UpdateTableError>,
> {
